 ...
 * upload it to the hipArray backing a GL texture via hipMemcpy2DToArray,
...
HIP_TEST_CASE(Unit_GLHIPImageData_Positive_HIPWrite_GLRead_UniquePerPixel) {
  ...
  HIP_CHECK(hipMemcpy2DToArray(array, 0, 0, expected.data(),
                                kWidth * sizeof(uint32_t),
                                kWidth * sizeof(uint32_t), kHeight,
