...
void VWmmaF3216x16x16F16Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  amdgpu::exec_f32(cu, 16, 16, 16, 2, 16, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
...
void VWmmaI3216x16x16Iu8Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_i32_i8(cu, 16, 16, 16, 2, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
...
void VWmmaF3216x16x16Fp8Fp8Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_f32(cu, 16, 16, 16, 2, 8, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
...
void VWmmaI3216x16x32Iu4Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_i32_i8(cu, 16, 16, 32, 2, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
                      amdgpu::src_base(vb, src1.state_.encoding_value), s2, const_acc);
}
...
void VSwmmacF3216x16x32F16Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_f32(cu, 16, 16, 32, 2, 16, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
                   amdgpu::src_base(vb, src1.state_.encoding_value), s2, amdgpu::extract_f16,
                   amdgpu::extract_f16, const_acc);
}
...
void VSwmmacI3216x16x64Iu4Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_i32_i8(cu, 16, 16, 64, 2, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
                      amdgpu::src_base(vb, src1.state_.encoding_value), s2, const_acc);
}
...
void VSwmmacF3216x16x32Fp8Fp8Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t s2 = amdgpu::resolve_acc(vb, dst, src2.state_.encoding_value, const_acc,
                                    [&] { return src2.read_scalar(wf); });
  amdgpu::exec_f32(cu, 16, 16, 32, 2, 8, dst, amdgpu::src_base(vb, src0.state_.encoding_value),
                   amdgpu::src_base(vb, src1.state_.encoding_value), s2, amdgpu::extract_fp8,
                   amdgpu::extract_fp8, const_acc);
}
